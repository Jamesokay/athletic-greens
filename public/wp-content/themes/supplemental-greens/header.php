		...
		<header id="masthead" class="flex w-full items-center justify-between h-[80px] fixed z-50 left-0 px-6 md:px-12 transition-colors duration-300 border-b border-1 border-transparent">
			<div class="flex items-center gap-4">
				...
				<div class="relative text-6xl text-white m-0">
					<a id="default-logo" class="w-[96px] h-[38px] md:w-[118px] md:h-[48px] flex transition-opacity duration-300" href="<?php echo esc_url(home_url('/')); ?>" rel="home">
						<img src="https://cdn.sanity.io/images/jf30o7wb/production/1c9ae1277a7e5622fcccccf66edf5b007bde0316-119x48.svg" alt="AG1 Logo" />
					</a>
					<a id="scrolled-logo" class="w-[96px] h-[38px] md:w-[118px] md:h-[48px] absolute top-0 left-0 flex opacity-0 transition-opacity duration-300" href="<?php echo esc_url(home_url('/')); ?>" rel="home">
			...
			<div class="flex items-center gap-8">
				<button id="shop-button" class="flex items-center gap-2 appearance-none rounded-full px-4 py-2 md:px-6 md:py-3 bg-transparent border border-2 border-white hover:border-white text-white transition duration-300">
				...
				<div id="account-button" role="button" class="hidden md:flex text-white transition-all duration-300">
